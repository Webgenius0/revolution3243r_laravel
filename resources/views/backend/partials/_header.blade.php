                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-md-flex notifications">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow"
                                    ...
                                    <div class="drop-heading border-bottom p-2">
                                        <div class="d-flex align-items-center">
                                            <h6 class="mb-0">Notifications</h6>
                                            <div class="ms-auto">
                                                @if (auth()->check() && auth()->user()->unreadNotifications()->count() > 0)
                                                    <span class="badge bg-secondary">
                                                        <a onclick="markAllAsRead()" class="text-white"
                                    ...
                                    @if (auth()->check() && auth()->user()->notifications->count() > 0)
                                        @foreach (auth()->user()->notifications as $notification)
                                            <a class="dropdown-item d-flex align-items-start border-bottom"
                                                ...
                                                <div class="flex-fill text-underline">
                                                    <div class="fw-bold">
                                                        {{ $notification->data['title'] ?? 'New Notification' }}</div>
                                                    <div class="small text-muted">
                                                        {{ Str::words($notification->data['message'] ?? 'No Message', 2, '...') }}
                                                    </div>
                                                    <div class="small text-muted">
